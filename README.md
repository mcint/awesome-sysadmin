...
*Resourses in the same spirit. Clone, compile, configure, run.*

* [Awesome Selfhosted appications](https://github.com/Kickball/awesome-selfhosted) - Curated list of applications
